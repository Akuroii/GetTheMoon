...
// Set to false once /api/stats and /api/videos are deployed and returning
// real data. While true, the whole page (subscriber count, moon fill,
// milestone journey, carousels) runs on illustrative sample data instead of
// calling the API — this is what lets you open this file directly, with no
// server running, and see everything working. See README.md for the small
// backend addition /api/videos still needs (the `videos` + `milestoneReachedAt`
// fields) before you flip this off.
const USE_MOCK_DATA = true;

function mjMockStats(){
  return {
    subscribers: 82410,
    views: 15230412,
    videos: 191,
...
/* ============================================================
   ...
   Until that ships, USE_MOCK_DATA renders illustrative sample data so the
